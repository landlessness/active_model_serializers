      ...
      class Siren
        class BelongsToTest < Minitest::Test
          ...
          def test_includes_linked_post
            @adapter = ActiveModel::Serializer::Adapter::Siren.new(@serializer, include: [:post])
            expected = [{
              id: '42',
              type: 'posts',
              attributes: {
          ...
          def test_limiting_linked_post_fields
            @adapter = ActiveModel::Serializer::Adapter::Siren.new(@serializer, include: [:post], fields: { post: [:title] })
            expected = [{
              id: '42',
              type: 'posts',
              attributes: {
          ...
          def test_include_linked_resources_with_type_name
            serializer = BlogSerializer.new(@blog)
            adapter = ActiveModel::Serializer::Adapter::Siren.new(serializer, include: [:writer, :articles])
