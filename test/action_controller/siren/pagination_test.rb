  ...
  module Serialization
    class Siren
      class PaginationTest < ActionController::TestCase
        KAMINARI_URI = 'http://test.host/action_controller/serialization/siren/pagination_test/pagination_test/render_pagination_using_kaminari'
        WILL_PAGINATE_URI = 'http://test.host/action_controller/serialization/siren/pagination_test/pagination_test/render_pagination_using_will_paginate'
        ...
        class PaginationTestController < ActionController::Base
          ...
          def render_pagination_using_kaminari
            render json: using_kaminari, adapter: :siren
          end

          def render_pagination_using_will_paginate
            render json: using_will_paginate, adapter: :siren
          end

          def render_array_without_pagination_links
            setup
            render json: @array, adapter: :siren
          end
        end
