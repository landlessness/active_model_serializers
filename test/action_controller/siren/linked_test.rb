      ...
      class LinkedTest < ActionController::TestCase
        class LinkedTestController < ActionController::Base
          ...
          def render_resource_without_include
            setup_post
            render json: @post, adapter: :siren
          end

          def render_resource_with_include
            setup_post
            render json: @post, include: [:author], adapter: :siren
          end

          def render_resource_with_nested_include
            setup_post
            render json: @post, include: [comments: [:author]], adapter: :siren
          end

          def render_resource_with_nested_has_many_include
            setup_post
            render json: @post, include: 'author.roles', adapter: :siren
          end
          ...
          def render_collection_with_missing_nested_has_many_include
            setup_post
            @post.author = @author2
            render json: [@post, @post2], include: [author: [:roles]], adapter: :siren
          end
          ...
          def render_collection_with_include
            setup_post
            render json: [@post], include: 'author, comments', adapter: :siren
          end
        end
