class ActiveModel::Serializer::Adapter::Siren < ActiveModel::Serializer::Adapter
  ...
  def fragment_cache(cached_hash, non_cached_hash)
    ...
    ActiveModel::Serializer::Adapter::Siren::FragmentCache.new.fragment_cache(root, cached_hash, non_cached_hash)
  end
  ...
  def resource_identifier_type_for(serializer)
    if ActiveModel::Serializer.config.siren_resource_type == :singular
